...
<html>
	<head>
		<meta charset="utf-8">
		<title>Character build calculator for Fallout Online: Requiem</title>
		...
		<link rel="stylesheet" href="style_eng.css">
		<script type="text/javascript" async src="js/jquery-3.1.0.min.js"></script>
		...
		<script type = "text/javascript" async src = "js/text_eng.js"></script>
        <script type = "text/javascript" async src = "js/LZW.js"></script>
		<script type = "text/javascript" async src = "js/base64.min.js"></script>
	...
	<body>      
        ...
        <div id="main" class="main">
            ...
            <div id="entername" class="text">
                <div id="nametext" class="text shadow">NAME</div>
                <div id="namenter" class="text2" contenteditable></div>
                <div id="passtext" class="text shadow">PASSWORD</div>
            ...
            <div id="sex" class="text shadow">Man.</div>
            <div id="entersex" class="text">
                <div id="men"></div>
                <div id="women"></div>
            </div>
            <div id="special">
                <div id="STRn" class="STR text special shadow">ST</div>
                <div id="STR" class="STR numspec npoint"></div>
                <div id="STRt" class="STR znach">Avrg</div>
                <div id="plusSTR" class="STR key reg spec plus" ></div>
                <div id="minusSTR" class="STR key reg spec minus" ></div>
                <div id="PERn" class="PER text special shadow">PE</div>
                <div id="PER" class="PER numspec npoint"></div>
                <div id="PERt" class="PER znach">Avrg</div>
                <div id="plusPER" class="PER key reg spec plus" ></div>
                <div id="minusPER" class="PER key reg spec minus" ></div>
                <div id="ENUn" class="ENU text special shadow">EN</div>
                <div id="ENU" class="ENU numspec npoint"></div>
                <div id="ENUt" class="ENU znach">Avrg</div>
                <div id="plusENU" class="ENU key reg spec plus" ></div>
                <div id="minusENU" class="ENU key reg spec minus" ></div>
                <div id="CHAn" class="CHA text special shadow">CH</div>
                <div id="CHA" class="CHA numspec npoint"></div>
                <div id="CHAt" class="CHA znach">Avrg</div>
                <div id="plusCHA" class="CHA key reg spec plus" ></div>
                <div id="minusCHA" class="CHA key reg spec minus" ></div>
                <div id="INTn" class="INT text special shadow">IN</div>
                <div id="INT" class="INT numspec npoint"></div>
                <div id="INTt" class="INT znach">Avrg</div>
                <div id="plusINT" class="INT key reg spec plus" ></div>
                <div id="minusINT" class="INT key reg spec minus" ></div>
                <div id="AGIn" class="AGI text special shadow">AG</div>
                <div id="AGI" class="AGI numspec npoint"></div>
                <div id="AGIt" class="AGI znach">Avrg</div>
                <div id="plusAGI" class="AGI key reg spec plus" ></div>
                <div id="minusAGI" class="AGI key reg spec minus" ></div>
                <div id="LUCn" class="LUC text special shadow">LK</div>
                <div id="LUC" class="LUC numspec npoint"></div>
                <div id="LUCt" class="LUC znach">Avrg</div>
                <div id="plusLUC" class="LUC key reg spec plus" ></div>
                <div id="minusLUC" class="LUC key reg spec minus" ></div>
            </div>
            <div id="specialpointext" class="text reg shadow">SPECIAL.</div><div id="specialpoint" class="text reg npoint"></div>
            <div id="experience" class="leveling text2">
                <div id="textlevel">Level:</div>
                <div id="level"></div>
                <div id="textexp">Exp:</div>
                <div id="exp"></div>
                <div id="textnextexp">Next lvl:</div>
                <div id="nextexp"></div>
                <div id="levelup"></div>
                <div id="leveldown"></div>
            </div>
            <div id="feat1" class="text2"> 
                <div id="life" class="resist res-2">Hitpoints</div><div id="live" class="resist resnum0 res-2"></div>
                <div id="dadge" class="resist res-1">Evasion</div><div id="dodge" class="resist resnum0 res-1"></div>
                <div id="anticrit" class="resist res0">Anticrit</div><div id="acrit" class="resist resnum0 res0">0%</div>
                <div id="textnormal" class="resist res1">Normal</div><div id="normal" class="resist resnum0 res1"></div>
                <div id="textlaser" class="resist res2">Laser</div><div id="laser" class="resist resnum0 res2"></div>
                <div id="textfire" class="resist res3">Fire</div><div id="fire" class="resist resnum0 res3"></div>
                <div id="textplasma" class="resist res4">Plasma</div><div id="plasma" class="resist resnum0 res4"></div>
                <div id="textexplode" class="resist res5">Explosion</div><div id="explode" class="resist resnum0 res5"></div>
                <div id="textelectro" class="resist res6">Electro</div><div id="electro" class="resist resnum0 res6"></div>
            ...
            <div id="feat2" class="text2"> 
                <div id="armorclass" class="text2 featop0">Armor class</div><div id="armc" class="text2 featnum featop0"></div>
                <div id="actionpoint" class="text2 featop1">Action points</div><div id="apoi" class="text2 featnum featop1"></div>
                <div id="maxload" class="text2 featop2">Maximum AP</div><div id="maxl" class="text2 featnum featop2"></div>
                <div id="meledmg" class="text2 featop3">Melee damage</div><div id="mdmg" class="text2 featnum featop3"></div>
                <div id="overview" class="text2 featop4">Field of View</div><div id="oview"  class="text2 featnum featop4"></div>
                <div id="stabiltoxic" class="text2 featop5">Poison Res.</div><div id="stox" class="text2 featnum featop5"></div>
                <div id="stabilradi" class="text2 featop6">Radiation Res.</div><div id="srad" class="text2 featnum featop6"></div>
                <div id="procedure" class="text2 featop7">Sequence</div><div id="proc" class="text2 featnum featop7"></div>
                <div id="levelhil" class="text2 featop8">Healing Rate</div><div id="levh" class="text2 featnum featop8"></div>
                <div id="critrate" class="text2 featop9">Critical Chance</div><div id="crit" class="text2 featnum featop9"></div>
            </div>
            ...
            <div id="skillpoint1" class="text leveling shadow">SKILLPOINTS</div>
            <div id="point1" class="leveling npoint"></div>
            <div id="skillpoint2" class="text reg shadow">TAGS</div>
            ...
            <div id="switch" class="leveling">
                <div id="switch1"></div>
                <div id="textswitch1" class="text shadow">BONUSES</div>
                <div id="switch2"></div>
                <div id="textswitch2" class="text shadow">BOOKS</div>
                <div id="switch3"></div>
            ...
            <div id="traits" class="text2 reg">
                ...
                <div id="TRAIT_SMALL_FRAME" class="text2 left3">Small Frame</div>
                <div id="TRAIT_ONE_HANDER" class="text2 left4">One Handed</div>
                <div id="TRAIT_FINESSE" class="text2 left5">Finesse</div>
                <div id="TRAIT_KAMIKAZE" class="text2 left6">Kamikaze</div>
                <div id="TRAIT_HEAVY_HANDED" class="text2 left7">Heavy Handed</div>
                <div id="TRAIT_FAST_SHOT" class="text2 left8">Fast Shoot</div>
                <div id="TRAIT_BLOODY_MESS" class="text2 right left1">Maniac</div>
                <div id="TRAIT_JINXED" class="text2 right left2">Jinxed</div>
                <div id="TRAIT_GOOD_NATURED" class="text2 right left3">Goodheart</div>
                <div id="TRAIT_CHEM_RELIANT" class="text2 right left4">Chemist</div>
                <div id="TRAIT_CHEM_RESISTANT" class="text2 right left5">Stable</div>
                <div id="TRAIT_SEX_APPEAL" class="text2 right left6">Liquid Body</div>
                <div id="TRAIT_SKILLED" class="text2 right left7">Skilled</div>
                <div id="TRAIT_NIGHT_PERSON" class="text2 right left8">Impulsive</div>
            </div>
            ...
            <div id="createlistperk" class="text2">
                ...
                <div id="fotterperk" class="text2"><center><hr><!--a href="../message.php">Message author</a--></center></div>
            </div>
            <div id="total" class="text2">
                <textarea id="totaltext" name="text"></textarea>
                <div id="loadtotal" class="shadow">LOAD</div>
                <div id="canceltotal"></div>
            </div>
            <div id="loadkey" class="text reg shadow">LOAD</div>
            <div id="totalkey" class="text leveling shadow">SUMMARY</div>
			<div id="by" class="text2">by ZingerY by supported <a href="http://bountyhunters.ixbb.ru/">BountyHunters</a></div>
            <?			
			if(isset($_COOKIE["id"])) {
				include '../config.php';
